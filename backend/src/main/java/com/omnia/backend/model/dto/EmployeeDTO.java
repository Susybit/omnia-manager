...
public class EmployeeDTO {
    ...
    @Pattern(regexp = "^[SC]$", message = "El estado civil debe ser 'S' (Soltero) o 'C' (Casado)")
    private String maritalStatus;

    /** Indicador de titulación superior: [S]í, [N]o. */
    @NotBlank(message = "La formación académica es obligatoria")
    @Pattern(regexp = "^[SN]$", message = "La formación debe ser 'S' (Sí tiene título) o 'N' (No tiene título)")
