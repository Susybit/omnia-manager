...
import com.omnia.backend.service.AuthService;
...
class AuthControllerTest {
    ...
    void login_ShouldReturnOk() throws Exception {
        ...
        request.setEmail("admin@omnia.com");
        request.setPassword("S12345678*");

        AuthResponseDTO response = new AuthResponseDTO();
        response.setEmail("admin@omnia.com");
        ...
        mockMvc.perform(post("/auth/login")
                ...
                .andExpect(jsonPath("$.email").value("admin@omnia.com"))
